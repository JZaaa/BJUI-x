        ...
        var b = {
            ...
            init: function(c) {
                ...
                a.extend(b.statusCode, d.statusCode),
                    ...
                    a.extend(b.alertMsg, d.alertMsg),
            ...
            initEnv: function() {
                a(window).resize(function() {
                    var c = a(this).width();
                    b.ui.windowWidth && b.ui.windowWidth > 600 && b.ui.windowWidth < c && (c = b.ui.windowWidth),
                        b.initLayout(c),
                        setTimeout(function() {
            ...
            initLayout: function(c) {
                ...
                b.ui.windowWidth && a("#bjui-window").width(c),
                    b.windowWidth = c,
                    a("#bjui-container").height(e),
                    a("#bjui-navtab").width(d),
                    a("#bjui-leftside, #bjui-sidebar, #bjui-sidebar-s, #bjui-splitBar, #bjui-splitBarProxy").css({
                        height: "100%"
                    }),
                    a("#bjui-navtab .tabsPageContent").height(e - f),
                    setTimeout(function() {
                            a("#bjui-navtab > .tabsPageContent > .navtabPage").resizePageH(),
                                a("#bjui-navtab > .tabsPageContent > .navtabPage").find(".bjui-layout").resizePageH()
                        },
                        10),
                    g = a("body").data("bjui.navbar.width"),
                    h = a("#bjui-header"),
                    i = h.find(".bjui-navbar-toggle"),
                    j = h.find(".bjui-navbar-logo"),
                    k = a("#bjui-navbar-collapse"),
                    l = k.find(".bjui-navbar-right"),
                g || (g = {
                    logoW: j.outerWidth(),
                    navW: l.outerWidth()
                },
                    a("body").data("bjui.navbar.width", g)),
                g && (c - g.logoW < g.navW ? (i.show(), k.addClass("collapse menu")) : (i.hide(), k.removeClass("collapse menu in"))),
                    m = a("#bjui-hnav-navbar-box"),
                    n = m.find("> #bjui-hnav-navbar"),
                    o = m.prev(),
                    p = m.next(),
                    q = m.width(),
                    r = 0,
                    n.find("> li").each(function() {
                        var c = a(this);
                        r += c.outerWidth(),
                            r > q ? (p.show(), m.data("hnav.move", !0).data("hnav.liw", r)) : (o.hide(), p.hide(), m.removeData("hnav.move"))
                    })
            },
            regional: {},
        ...
        a.fn.extend({
            ...
            doAjax: function(b) {
                ...
                return b.url ? b.callback ? (b.callback = b.callback.toFunc(), b.loadingmask && (d = c.getPageTarget(), d.trigger(BJUI.eventType.ajaxStatus), e = d.find("> .bjui-ajax-mask")), b.type || (b.type = "POST"), b.dataType || (b.dataType = "json"), b.cache || (b.cache = !1), b.timeout = BJUI.ajaxTimeout, b.success = function(c) {
                    ...
                    b.error = b.error ||
                        function(a, b, f) {
                            c.bjuiajax("ajaxError", a, b, f),
                            e && d.trigger("bjui.ajaxError")
                        },
                ...
                return this.each(function() {
                    if (!a(this).closest(".tab-content").length) {
                        var b = a(this),
                            ...
                            f = c.outerHeight() || 0,
                            g = e.outerHeight() || 0;
                        b.hasClass("navtabPage") && b.is(":hidden") && (b.show(), f = c.outerHeight() || 0, g = e.outerHeight() || 0, b.hide()),
                        e.css("bottom") && (g += parseInt(e.css("bottom")) || 0),
                        0 == g && b.hasClass("dialogContent") && (g = 5),
                            d.css({
                                top: f,
                                bottom: g
                            })
    ...
    function(a) {
        ...
        b.prototype.init = function() {
            ...
            this.options.obj && (this.options.$obj = this.options.obj),
                this.options.event ? this.start(this.options.event) : this.$element.find(this.options.selector).bind("mousedown",
                    function(b) {
                        a.start.apply(a, [b])
                    })
        },
            b.prototype.start = function() {
                ...
                this.options.oleft = parseInt(this.$element.css("left")) || 0,
                    ...
                    a(document).bind("mouseup.bjui.basedrag",
                        function(a) {
                            c.stop.apply(c, [a])
                        }).bind("mousemove.bjui.basedrag",
                        function(a) {
                            c.drag.apply(c, [a])
                        })
            },
            b.prototype.drag = function(b) {
                ...
                c.drag && c.drag.apply(this.$element, [this.$element, b]),
                    this.preventEvent(b)
            },
            b.prototype.stop = function(b) {
                return a(document).unbind("mousemove.bjui.basedrag").unbind("mouseup.bjui.basedrag"),
                this.options.stop && this.options.stop.apply(this.$element, [this.$element, b]),
            ...
            b.prototype.destroy = function() {
                ...
                this.options.nounbind || this.$element.unbind("mousedown")
            },
            d = a.fn.basedrag,
            a.fn.basedrag = c,
...
+
    function(a) {
        ...
        a(function() {
            ...
            b.prototype.init = function() {
                var b = this;
                BJUI.ui.showSlidebar ? b.hoverLock() : b.unlock(),
                    this.$lock.off("click.bjui.slidebar").on("click.bjui.slidebar",
                        function() {
                            b.isfloat ? b.lock() : b.unlock(),
                                BJUI.ui.showSlidebar = !BJUI.ui.showSlidebar
                        }),
                    this.$collapse.hover(function() {
                        b.float(),
                            b.$navtab.click(function() {
                                ...
                                d.css({
                                    ...
                                    stop: function() {
                                        ...
                                        a(this).css("visibility", "hidden"),
                                            c = parseInt(a(this).css("left")) - parseInt(b.$split.css("left")),
                                            d = b.$bar.outerWidth() + c,
                                            e = parseInt(b.$navtab.css("left")) + c,
                                            f = b.$navtab.outerWidth() - c,
                                            b.$bar.css("width", d),
                                            b.$split.css("left", a(this).css("left")),
                                            b.$navtab.css({
                                                left: e,
                                                width: f
                                            })
            ...
            b.prototype.initHnav = function() {
                ...
                f = d.find("> .items > ul.ztree"),
                    g = d.find("> .items > ul.menu-items"),
                (f.length || g.length) && (f.length && (i = f), g.length && (i = i ? i.add(g) : g, g.find("a").each(function() {
                    var b = a(this),
                        c = b.data("options"); ! b.data("icon.init") && c && "string" == typeof c && (c = c.toObj(), c && c.faicon && (c.faicon = c.faicon.trim(), c.faicon.startsWith("fa-") && (c.faicon = c.faicon.substr(3)), b.prepend('<i class="fa fa-' + c.faicon + '"></i>').data("icon.init", !0).attr("title", b.text())))
                })), e.empty(), i.each(function(b) {
                    var f, g, i, d = a(this),
                        j = d.data("faicon"),
                        l = (d.data("faiconClose"), j ? j: "dot-circle-o");
                    d.data("tit") && (c = d.data("tit")),
                        g = b ? "collapsed": "",
                        i = b ? "": " in",
                        f = FRAG.slidePanel.replaceAll("#id#", "bjui-collapse" + b).replaceAll("#title#", c).replaceAll("#righticon#", '<i class="fa fa-angle-down"></i>').replaceAll("#class#", g).replaceAll("#bodyclass#", i),
                        f = l ? f.replaceAll("#icon#", '<i class="fa fa-' + l + '"></i>') : f.replaceAll("#icon#", ""),
                        h = a(f),
                        h.find("> .panel-collapse > .panel-body").append(d.removeAttr("data-noinit")),
                        e.append(h),
                    b || h.collapse("show")
            ...
            a(document).one(BJUI.eventType.afterInitUI,
                function() {
            ...
            a(document).on("click.bjui.slidebar.data-api", '[data-toggle="slidebar"]',
                function(b) {
                    var d = a(this).parent(),
                        e = a("#bjui-accordionmenu"),
                        f = d.data("bjui.slidebar.hnav.panels");
                    e.find("> .panel").detach(),
                        f && f.length ? (e.append(f), d.addClass("active").siblings().removeClass("active")) : c.call(a(this), "initHnav"),
                        b.preventDefault()
                })
    } (jQuery);
/**
        ...
        a(function() {
            ...
            e.prototype.init = function() {
                ...
                b.id && (d.push({
                    ...
                    bindings: b.bindings || {},
                    ctrSub: b.ctrSub
                }), c = d.length - 1, this.$element.on("contextmenu",
                    function(d) {
            ...
            e.prototype.show = function(b) {
                var c = this;
                b.items && b.items.length && c.$element.on("contextmenu",
                    function(d) {
                        var e = !0;
            ...
            e.prototype.custom = function(d, e) {
                ...
                b.empty().html("<ul></ul>"),
                    ...
                    a.each(d,
                        function(b, c) {
                            var d = "";
                            c.icon && (d = '<i class="fa fa-' + c.icon + '"></i>'),
                                "diver" == c.title ? i = a('<li class="diver"></li>') : (i = a('<li><span class="icon">' + d + '</span><span class="title">' + c.title + "</span></li>"), c.func && "string" == typeof c.func && (c.func = c.func.toFunc()), c.func && i.on("click",
                                    function() {
                                        f.hide(),
                                            c.func(f.$element, i)
                                    })),
    ...
    function(a) {
        ...
        function p(b) {
            ...
            return this.each(function() {
                var e = a(this),
                    f = a.extend({},
                        o.DEFAULTS, "object" == typeof b && b),
                    g = e.data("bjui.navtab");
                g || e.data("bjui.navtab", g = new o(this, f)),
                    "string" == typeof d && a.isFunction(g[d]) ? ([].shift.apply(c), c ? g[d].apply(g, c) : g[d]()) : (g = new o(this, f), g.openTab())
            })
        }
        ...
        a(function() {
            var c = function() {
                b = 0,
                    ...
                    a(document).on("click.bjui.navtab.switchtab",
                        function(b) {
                ...
                l.navtab("contextmenu", l).click(function() {
                    ...
                    l.data("initOptions", d).data("options", d),
                l.attr("data-url") && a(document).one(BJUI.eventType.initUI,
                    function() {
                ...
                var j = this,
                    l = {
                        ...
                        switchTab: function(e) {
                            ...
                            f.data("reloadFlag") ? (g.hide(), h.show(), j.refresh(f.data("initOptions").id)) : (g.hide(), h.find(".bjui-ajax-mask").length ? h.show() : (h.addClass("fade").removeClass("in").show(), a.support.transition ? h.one("bsTransitionEnd",
                                function() {
                                    h.addClass("in")
                        ...
                        closeTab: function(a, c) {
                            var l, d = this.getTabs().eq(a),
                                ...
                                k = !0;
                            return h && (k = h.apply(j, [f])),
                                k ? (d.remove(), e.remove(), f.trigger(BJUI.eventType.beforeCloseNavtab).remove(), n && clearInterval(n), i && i.apply(j), b >= a && b--, c && (l = this.indexTabId(c), l > 0 && (b = l)), this.scrollCurrent(), this.switchTab(b), void 0) : (j.tools.switchTab(a), void 0)
                        },
                ...
                a.contextmenu({
                    ...
                    ctrSub: function(a, b) {
                        ...
                        b.find('[rel="closeOther"]'),
                            b.find('[rel="closeAll"]'),
                            c.tools.getTabs(),
                        0 == a.index() && (e.addClass("disabled"), a.data("url") || d.addClass("disabled"))
                    }
                })
            },
            o.prototype.openTab = function() {
                var i, j, l, m, n, o, p, c = this,
                    ...
                    e = this.options,
                    h = this.tools;
                return ! e.url && e.href && (e.url = e.href),
                    e.url ? (e.url = decodeURI(e.url).replacePlh(d.closest(".unitBox")), e.url.isFinishedTm() ? (e.url = encodeURI(e.url), i = e.id ? h.indexTabId(e.id) : b, e.id || BJUI.ui.overwriteHomeTab || 0 != i || (e.id = "navtab", i = -1), i >= 0 ? (e.id || delete e.id, j = h.getTabs().eq(i), l = h.getPanels().eq(i), m = j.data("initOptions"), n = a.extend({},
                        m, e), (m.fresh || e.fresh || m.url != e.url) && c.reload(n), b = i) : (o = '<li><a href="javascript:" title="#title#"><span>#title#</span></a><span class="close">&times;</span></li>', j = a(o.replaceAll("#title#", e.title)), l = a('<div class="navtabPage unitBox"></div>'), p = a('<li><a href="javascript:" title="#title#">#title#</a></li>'.replaceAll("#title#", e.title)), j.appendTo(f), l.appendTo(g), p.appendTo(k), j.data("options", e).data("initOptions", e), e.external || e.url && e.url.isExternalUrl() ? (j.addClass("external"), this.openExternal(e.url, l)) : (j.removeClass("external"), h.reloadTab(l, e)), b = h.getTabs().length - 1, this.contextmenu(j), j.on("click",
                        function(b) {
                            var d = a(b.target);
            ...
            o.prototype.reload = function(c, d) {
                ...
                g && (h = g.data("initOptions") || {},
                    i = a.extend({},
                        h, f), j = function() {
                    h.title != i.title && g.find("> a").attr("title", i.title).find("> span").html(i.title),
            ...
            q = a.fn.navtab,
            a.fn.navtab = p,
            a.fn.navtab.Constructor = o,
            a.fn.navtab.noConflict = function() {
                return a.fn.navtab = q,
                    this
            },
            a(document).on("click.bjui.navtab.data-api", '[data-toggle="navtab"]',
                function(b) {
                    var c = a(this),
                        d = c.attr("href"),
                        e = c.data(),
                        f = e.options;
                    f && ("string" == typeof f && (f = f.toObj()), "object" == typeof f && a.extend(e, f)),
    ...
    function(a) {
        ...
        function g(b) {
            ...
            return this.each(function() {
                var e = a(this),
                    g = a.extend({},
                        f.DEFAULTS, "object" == typeof b && b),
                    h = e.data("bjui.dialog");
                h || e.data("bjui.dialog", h = new f(this, g)),
                    "string" == typeof d && a.isFunction(h[d]) ? ([].shift.apply(c), c ? h[d].apply(h, c) : h[d]()) : (h = new f(this, g), h.open())
            })
        }
        var b, c, d, e, f, h;
        a(function() {
            var c = function() {
                b = a("#bjui-resizable"),
                    d = "dialogShadow",
                    e = f.ZINDEX,
                    a("body").append("<!-- dialog resizable -->").append(FRAG.resizable)
            };
            c()
        }),
            f = function(b, c) {
            ...
            f.prototype.open = function() {
                ...
                if (d.target && a(d.target).length) d.url = void 0;
                    ...
                    if (!d.url && d.href && (d.url = d.href), !d.url) return BJUI.debug("Dialog Plugin: Error trying to open a dialog, url is undefined!"),
                        void 0;
                ...
                g ? (h = g.data("initOptions") || d, this.switchDialog(g), g.is(":hidden") && g.show(), (h.fresh || d.fresh || !h.url || h.url != d.url) && (b.reload(d), g.data("initOptions", d))) : (i = BJUI.regional.dialog, j = FRAG.dialog.replace("#close#", i.close).replace("#maximize#", i.maximize).replace("#restore#", i.restore).replace("#minimize#", i.minimize).replace("#title#", i.title), g = a(j).data("options", d).data("initOptions", d).css("zIndex", e += 1).hide().appendTo(f), g.find("> .dialogHeader > h1 > span.title").html(d.title), this.tools.init(g), d.maxable ? g.find("a.maximize").show() : g.find("a.maximize").hide(), d.minable ? g.find("a.minimize").show() : g.find("a.minimize").hide(), d.max && b.maxsize(g), d.mask ? this.addMask(g) : d.minable && a.fn.taskbar && this.$element.taskbar({
                    ...
                    }).on("mousedown.bjui.dialog.drag", ".dialogHeader > h1",
                    function(c) {
                        b.switchDialog(g),
                    ...
                    }).on("mouseup.bjui.dialog.drag", ".dialogHeader > h1",
                    function() {
                        g.data("bjui.dialog.task", !1)
                    }).on("mousedown.bjui.dialog.resize", 'div[class^="resizable"]',
                    function(c) {
                    ...
                    }).on("mouseup.bjui.dialog.resize", 'div[class^="resizable"]',
                    function(a) {
                        a.preventDefault()
            ...
            f.prototype.addMask = function(b) {
                ...
                b.wrap('<div style="z-index:' + e + '" class="bjui-dialog-wrap"></div>'),
                    b.find("> .dialogHeader > a.minimize").hide(),
                c && c.length || (c = a(FRAG.dialogMask), c.css("zIndex", 1).show().insertBefore(b), b.data("bjui.dialog.mask", c))
            },
            ...
            f.prototype.close = function(b) {
                var d = this,
                    ...
                    m = !0;
                if (g && i) {
                    if (k && (m = k.apply(d, [g])), !m) return d.switchDialog(g),
                        void 0;
                    i.target && j && a(i.target).html(j),
                        h && h.length ? (h.remove(), g.unwrap()) : a.fn.taskbar && this.$element.taskbar("closeDialog", i.id),
                        g.animate({
                                top: -g.outerHeight(),
                                opacity: .1
                            },
            ...
            f.prototype.drag = function(b, c) {
                a("#bjui-dialogProxy"),
                    c.find("> .dialogContent").css("opacity", ".3"),
                    c.basedrag({
            ...
            f.prototype.resizeDialog = function(b, c, d) {
                ...
                0 > g && (g = 0),
                    c.css({
                        ...
                        width: i + 2,
                        height: h + 1
                    }).find("> .dialogContent").css("width", i - 10),
            ...
            a(document).on("click.bjui.dialog.data-api", '[data-toggle="dialog"]',
                function(b) {
                    var c = a(this),
                        d = c.attr("href"),
                        e = c.data(),
    ...
    function(a) {
        ...
        function d(b) {
            ...
            return this.each(function() {
                var f = a(this),
                    g = a.extend({},
                        c.DEFAULTS, f.data(), "object" == typeof b && b),
                    h = f.data("bjui.bjuiajax");
                h || f.data("bjui.bjuiajax", h = new c(this, g)),
        ...
        c.DEFAULTS = {
                    ...
                    d = {
                        getPagerForm: function(b, c) {
                            var f, g, d = b.isTag("form") ? b[0] : b.find("#pagerForm:first")[0],
                                e = a.extend({},
                                    BJUI.pageInfo);
                            if (b.data("bjui.clientPaging") && (c = a.extend({},
                                    b.data("bjui.clientPaging"), c), b.data("bjui.clientPaging", c)), d) for (f in e) g = "",
                            c && c[f] && (g = c[f]),
            ...
            c.prototype.ajaxCallback = function(a) {
                ...
                b.ajaxDone(a),
                a[BJUI.keys.statusCode] == BJUI.statusCode.ok && (e && e.length ? b.divCallback(a, e) : b.tools.getTarget() == c.NAVTAB ? b.navtabCallback(a) : b.dialogCallback(a))
            },
            ...
            c.prototype.navtabCallback = function(b) {
                ...
                b.tabid && setTimeout(function() {
                    ...
                    100),
                b.dialogid && setTimeout(function() {
                        c.$element.dialog("refresh", b.dialogid)
                    },
                    100),
                b.divid && setTimeout(function() {
                        c.$element.bjuiajax("refreshDiv", b.divid)
                    },
                    100),
                b.datagrid && setTimeout(function() {
                        a.each(b.datagrid.join(","),
                            function(b, c) {
                                a("#" + c.trim()).datagrid("refresh")
                            })
                    },
                    100),
                    b.closeCurrent && !b.forward ? c.$element.navtab("closeCurrentTab") : c.options.reload && setTimeout(function() {
                            c.$element.navtab("refresh")
                        },
                        100),
                b.forward && (d = function() {
            ...
            c.prototype.doSearch = function(b) {
                ...
                b.url || (b.url = e.attr("action")),
                    b.url ? (b.url = decodeURI(b.url).replacePlh(e.closest(".unitBox")), b.url.isFinishedTm() ? (b.url = encodeURI(b.url), j = function() {
                        var i, j, k, l;
                        if (h && h.length) {
            ...
            c.prototype.doLoad = function(b) {
                ...
                return b = a.extend({},
                    c.DEFAULTS, "object" == typeof b && b),
                    b.url ? (b.url = decodeURI(b.url).replacePlh(e.closest(".unitBox")), b.url.isFinishedTm() ? (b.url = encodeURI(b.url), f && f.length ? (f && f.length && (f.removeData("bjui.clientPaging"), d.reloadDiv(f, b)), void 0) : (BJUI.debug("Not set loaded 'ajax' content container, like [data-target]."), void 0)) : (e.alertmsg("error", b.warn || FRAG.alertPlhMsg.replace("#plhmsg#", BJUI.regional.plhmsg)), BJUI.debug("The ajax link incorrect: " + b.url), void 0)) : (BJUI.debug("Error trying to open a ajax link: The url is undefined!"), void 0)
            },
            c.prototype.refreshLayout = function(d) {
                var e = this,
                    g = (e.$element, d.target ? a(d.target) : null);
                return d = a.extend({},
                    c.DEFAULTS, "object" == typeof d && d),
                    g && g.length ? (g && g.length && (g.removeData("bjui.clientPaging"), e.reloadDiv(g, a.extend({},
                        g.data("options") || {},
                        d))), void 0) : (b && clearInterval(b), BJUI.debug("Not set loaded 'ajax' content container, like [data-target]."), void 0)
            },
            c.prototype.reloadDiv = function(a, c) {
                ...
                a.addClass("bjui-layout").data("options", c).ajaxUrl({
                    ...
                    callback: function() {
                        BJUI.ui.clientPaging && a.data("bjui.clientPaging") && a.pagination("setPagingAndOrderby", a),
                        c.callback && c.callback.apply(this, [a]),
                        b && clearInterval(b),
            ...
            c.prototype.doAjax = function(b) {
                ...
                return b = a.extend({},
                    c.DEFAULTS, "object" == typeof b && b),
                    b.url ? (b.url = decodeURI(b.url).replacePlh(e.closest(".unitBox")), b.url.isFinishedTm() ? (b.url = encodeURI(b.url), f = b.callback && b.callback.toFunc(), g = function() {
                        e.doAjax({
                            type: b.type,
                            url: b.url,
                            data: b.data,
            ...
            c.prototype.doExport = function(b) {
                ...
                return b.url ? (b.url = decodeURI(b.url).replacePlh(e.closest(".unitBox")), b.url.isFinishedTm() ? (h = function() {
                    f && f.length || (f = d.tools.getTarget() == c.NAVTAB ? a.CurrentNavtab: a.CurrentDialog),
                        g = d.tools.getPagerForm(f),
                    g && (b.url = encodeURI(b.url + ( - 1 == b.url.indexOf("?") ? "?": "&") + a(g).serialize())),
                        a.fileDownload(b.url, {
                            failCallback: function(a) {
                                a.trim().startsWith("{") && (a = a.toObj()),
                                    d.ajaxDone(a)
                            }
                        })
                },
            ...
            c.prototype.doAjaxChecked = function(b) {
                ...
                return b = a.extend({},
                    c.DEFAULTS, "object" == typeof b && b),
                    b.url ? (b.url = decodeURI(b.url).replacePlh(e.closest(".unitBox")), b.url.isFinishedTm() ? (g = function() {
                        var g, h, i;
            ...
            e = a.fn.bjuiajax,
            a.fn.bjuiajax = d,
            a.fn.bjuiajax.Constructor = c,
            a.fn.bjuiajax.noConflict = function() {
                return a.fn.bjuiajax = e,
                    this
            },
            a(document).on("submit.bjui.bjuiajax.data-api", 'form[data-toggle="ajaxform"]',
                function(b) {
                    var c = a(this),
                        e = c.data();
                    d.call(c, "ajaxForm", e),
            ...
            a(function() {
                a.validator ? a(document).on(BJUI.eventType.initUI,
                    function(b) {
                    ...
                    }) : a(document).on("submit.bjui.bjuiajax.data-api", 'form[data-toggle="ajaxsearch"]',
                    function(b) {
                        var c = a(this),
                            e = c.data();
                        d.call(c, "doSearch", e),
            ...
            a(document).on("click.bjui.bjuiajax.data-api", '[data-toggle="reloadsearch"]',
                function(b) {
                    var e, c = a(this),
                        f = c.closest("form");
                    f && f.length && (e = f.data(), e.clearQuery = c.data("clearQuery") || !0, d.call(f, "doSearch", e), b.preventDefault())
                }),
            a(document).on("click.bjui.bjuiajax.data-api", '[data-toggle="ajaxload"]',
                function(b) {
                    var c = a(this),
                        e = c.data();
                    e.url || (e.url = c.attr("href")),
                        d.call(c, "doLoad", e),
                        b.preventDefault()
                }),
            a(document).on(BJUI.eventType.initUI,
                function(b) {
            ...
            a(document).on("click.bjui.bjuiajax.data-api", '[data-toggle="refreshlayout"]',
                function() {
                    var c = a(this),
                        e = c.data();
                    d.call(c, "refreshLayout", e)
                }),
            a(document).on("click.bjui.bjuiajax.data-api", '[data-toggle="doajax"]',
                function(b) {
                    var c = a(this),
                        e = c.data();
                    e.url || (e.url = c.attr("href")),
            ...
            a(document).on("click.bjui.bjuiajax.data-api", '[data-toggle="doexport"]',
                function(b) {
                    var c = a(this),
                        e = c.data();
                    e.url || (e.url = c.attr("href")),
            ...
            a(document).on("click.bjui.bjuiajax.data-api", '[data-toggle="doexportchecked"]',
                function(b) {
                    var c = a(this),
                        e = c.data();
                    e.url || (e.url = c.attr("href")),
                        d.call(c, "doExportChecked", e),
                        b.preventDefault()
                }),
            a(document).on("click.bjui.bjuiajax.data-api", '[data-toggle="doajaxchecked"]',
                function(b) {
                    var c = a(this),
                        e = c.data();
                    e.url || (e.url = c.attr("href")),
                        d.call(c, "doAjaxChecked", e),
                        b.preventDefault()
                })
    } (jQuery);
/**
    ...
    function(a) {
        ...
        a(function() {
                ...
                var e = this,
                    ...
                    g = {
                        ...
                        open: function(g, h, i) {
                            ...
                            if (i) for (o = 0; o < i.length; o++) p = i[o].call ? "callback": "",
                                q = i[o].cls ? i[o].cls: "default",
                                r = i[o].cls && "green" == i[o].cls ? "check": "close",
                                k += FRAG.alertBtnFrag.replace("#btnMsg#", '<i class="fa fa-' + r + '"></i> ' + i[o].name).replace("#callback#", p).replace("#class#", q);
                            l = a(FRAG.alertBoxFrag.replace("#type#", g).replace("#fa#", f.fas[g]).replace("#title#", this.getTitle(g)).replace("#message#", h).replace("#btnFragment#", k)).hide().appendTo("body"),
                            b && b.length && b.remove(),
                                b = l,
                                j.openPosition(),
                            d && (clearTimeout(d), d = null),
                            null == f.mask && f.types.info != g && f.types.correct != g && c.show(),
                            null == f.autoClose && (f.types.info == g || f.types.correct == g) && (n ? f.alertTimeout && 3e3 != f.alertTimeout && (n = f.alertTimeout) : n = f.alertTimeout, d = setTimeout(function() {
                                    j.close()
                                },
                                n)),
                                m = b.find(".btn"),
                                m.each(function(b) {
                                    a(this).on("click", a.proxy(function() {
                                            e.tools.close();
                                            var a = i[b].call;
                                            "string" == typeof a && (a = a.toFunc()),
                                            "function" == typeof a && a.call()
                                        },
                                        e)),
                                    i[b].keyCode == BJUI.keyCode.ENTER && a(document).on("keydown.bjui.alertmsg.ok", {
                                            target: m.eq(b)
                                        },
                                        j.keydownOk),
                                    i[b].keyCode == BJUI.keyCode.ESC && a(document).on("keydown.bjui.alertmsg.esc", {
                                            target: m.eq(b)
                                        },
                                        j.keydownEsc)
                                })
            ...
            e.prototype.confirm = function(b, c) {
                var d, e;
                a.extend(this.options, "object" == typeof c && c),
                    d = a.extend({},
                        {
                            okName: BJUI.regional.alertmsg.btnMsg.ok,
                            okCall: null,
            ...
            a(document).on("click.bjui.alertmsg.data-api", '[data-toggle="alertmsg"]',
                function(b) {
                    var g, c = a(this),
                        d = c.data(),
                        e = d.options;
                    return e && ("string" == typeof e && (e = e.toObj()), "object" == typeof e && a.extend(d, e)),
                        (g = d.type) ? (f.call(c, g, d.msg || g, d), b.preventDefault(), void 0) : !1
                })
    } (jQuery);
/**
...
+
    function(a) {
        ...
        b.DEFAULTS = {
            ...
            a(document).on("change.bjui.pagination.data-api", 'select[data-toggle-change="changepagesize"]',
                function(b) {
                    var d = a(this);
                    d.data(),
        ...
        function parseDate(a, b) {
            ...
            for (a += "", b += "", c = 0, d = 0, e = "", f = "", j = new Date(1900, 0, 1), k = j.getYear(), l = j.getMonth() + 1, m = 1, n = j.getHours(), o = j.getMinutes(), p = j.getSeconds(), q = ""; d < b.length;) {
                ...
                if ("yyyy" == f || "yy" == f || "y" == f) {
                    ...
                    c += k.length,
                    2 == k.length && (k = k > 70 ? 1900 + (k - 0) : 2e3 + (k - 0))
                } else if ("MMM" == f || "NNN" == f) {
        ...
        a(function() {
                ...
                var c = this,
                    d = {
                        ...
                        clickTmMenu: function(b, d) {
                            n.find("> ul").hide().filter("." + d).show().find("> li").off(c.events.click_tm).on(c.events.click_tm,
                                function() {
                                    var c = a(this),
            ...
            t.prototype.addBtn = function() {
                ...
                this.$dateBtn || this.options.addbtn || c.parent().hasClass("wrap_bjui_btn_box") || (this.$dateBtn = a(FRAG.dateBtn), this.$element.css({
                    ...
                    height: e,
                    lineHeight: e + "px"
                }).appendTo(d), this.$dateBtn.on("selectstart",
                    function() {
                        return ! 1
                    }))
            },
            t.prototype.init = function() {
                ...
                g.val(i.month),
                    f.add(g).off(this.events.change_ym).on(this.events.change_ym,
                        function() {
                            var a, c;
                    ...
                    d.off(this.events.click_prev).on(this.events.click_prev,
                        function() {
                            b.tools.changeMonth( - 1)
                        }),
                    e.off(this.events.click_prev).on(this.events.click_prev,
                        function() {
                            b.tools.changeMonth(1)
                        }),
                    r.off(this.events.click_clear).on(this.events.click_clear,
                        function() {
                            b.$element.val(""),
                                h.closeCalendar(!0)
                        }),
                    s.off(this.events.click_ok).on(this.events.click_ok,
                        function() {
                    ...
                    o.off(this.events.click_close).on(this.events.click_close,
                        function() {
                            h.closeCalendar(!0)
                        }),
                    a(document).on(this.events.click_close,
                        function(c) {
                            var d = a(c.target);
            ...
            t.prototype.create = function(d, e, f) {
                ...
                for (v = 1; v <= 42 - s - d.days; v++) w = new Date(d.year, d.month, v),
                    ...
                    t += '<dd class="other' + x + '" data-month="1" data-day="' + v + '">' + v + "</dd>";
                y = p.html(t).find("dd"),
                    y.not(".disabled").off(this.events.click_days).on(this.events.click_days,
                        function() {
                            var c, b = a(this);
                    ...
                    q.hasTime() ? (h.show(), k.val(d.hour < 10 ? "0" + d.hour: d.hour).off(this.events.focus_time).on(this.events.focus_time,
                        function() {
                            q.changeTmMenu("hh")
                        }), z = parseInt(d.minute / o.mmStep) * o.mmStep, l.val(10 > z ? "0" + z: z).data("step", o.mmStep).off(this.events.focus_time).on(this.events.focus_time,
                        function() {
                            q.changeTmMenu("mm")
                        }), m.val(q.hasSecond() ? d.second < 10 ? "0" + d.second: d.second: "00").data("step", o.ssStep).off(this.events.focus_time).on(this.events.focus_time,
                        function() {
                            q.changeTmMenu("ss")
                        ...
                        var b = a(this);
                        b.off(g.events.keyup_time).on(g.events.keyup_time,
                            function() {
                                q.changeTm(b)
                            })
                    }).off(this.events.click_time).on(this.events.click_time,
                        function() {
                            q.clickTmMenu(a(this), a(this).data("type"))
                        }), A = null, j.off(this.events.click_spinner).on(this.events.click_spinner,
                        function(b) {
                            var c = a(this);
                            i.filter(".slt").each(function() {
                                ...
                                b.preventDefault()
                        }).off(this.events.mousedown_sp).on(this.events.mousedown_sp,
                        function() {
                            var c = a(this);
                            A = setInterval(function() {
                                ...
                                150)
                        }).off(this.events.mouseup_sp).on(this.events.mouseup_sp,
                        function() {
                            clearTimeout(A)
            ...
            a(document).on("click.bjui.datepicker.data-api", '[data-toggle="datepickerbtn"]',
                function(b) {
                    var c = a(this).prevAll('[data-toggle="datepicker"]');
                    c && c.is(":text") && (u.call(c, c.data()), b.preventDefault())
                }),
            a(document).on("click.bjui.datepicker.data-api", '[data-toggle="datepicker"]',
                function(b) {
                    var c = a(this);
...
+
    function(a) {
        ...
        b.DEFAULTS = {
            ...
            a(document).on("click.bjui.ajaxtab.data-api", '[data-toggle="ajaxtab"]',
                function(b) {
                    var d = a(this),
                        e = d.data();
...
+
    function(d) {
        ...
        c.prototype.TOOLS = function() {
            ...
            var g = {
                ...
                showSubMenu: function(p, i, o) {
                    ...
                    p.on("bjui.datagrid.th.submenu.hide",
                        function(r, s, q) {
                            h(d(this), s, q)
                        })
                },
                    ...
                    if (n.toolbarItem) {
                        ...
                        d.each(n.toolbarItem.split(","),
                            function(o, p) {
                                ...
                                if (p == "add") {
                                    i.$toolbar_add = d(f).attr("data-icon", "plus").addClass("btn-blue").text(BJUI.getRegional("datagrid.add")).appendTo(l).on("click",
                                        function(q) {
                                            i.add()
                                        })
                                } else {
                                    if (p == "edit") {
                                        i.$toolbar_edit = d(f).attr("data-icon", "edit").addClass("btn-green").text(BJUI.getRegional("datagrid.edit")).appendTo(l).on("click",
                                            function(r) {
                                        ...
                                        if (p == "cancel") {
                                            i.$toolbar_calcel = d(f).attr("data-icon", "undo").addClass("btn-orange").text(BJUI.getRegional("datagrid.cancel")).appendTo(l).on("click",
                                                function(q) {
                                                    i.doCancelEditRow(i.$tbody.find("> tr." + i.classnames.tr_edit))
                                                })
                                        } else {
                                            if (p == "save") {
                                                i.$toolbar_save = d(f).attr("data-icon", "save").addClass("btn-default").text(BJUI.getRegional("datagrid.save")).appendTo(l).on("click",
                                                    function(q) {
                                                        i.doSaveEditRow()
                                                    })
                                            } else {
                                                if (p == "del") {
                                                    i.$toolbar_del = d(f).attr("data-icon", "times").addClass("btn-red").text(BJUI.getRegional("datagrid.del")).appendTo(l).on("click",
                                                        function(r) {
                                                            var q = i.$tbody.find("> tr." + i.classnames.tr_selected);
                                                            if (q.length) {
                                                                i.delRows(q)
                                                    ...
                                                    if (p == "refresh") {
                                                        i.$toolbar_refresh = d(f).attr("data-icon", "refresh").addClass("btn-green").text(BJUI.getRegional("datagrid.refresh")).appendTo(l).on("click",
                                                            function(q) {
                                                                i.refresh()
                                                            })
                                                    } else {
                                                        if (p == "import") {
                                                            i.$toolbar_add = d(f).attr("data-icon", "sign-in").addClass("btn-blue").text(BJUI.getRegional("datagrid.import")).appendTo(l).on("click",
                                                                function(r) {
                                                                    if (n.importOption) {
                                                            ...
                                                            if (p == "export") {
                                                                i.$toolbar_add = d(f).attr("data-icon", "sign-out").addClass("btn-green").text(BJUI.getRegional("datagrid.export")).appendTo(l).on("click",
                                                                    function(r) {
                                                                        if (n.exportOption) {
        ...
        c.prototype.initThead = function() {
            ...
            k.filter(".datagrid-quicksort-th").on("click.bjui.datagrid.quicksort",
                function(o) {
                    var n = d(o.target);
            ...
            k.filter(".datagrid-column-menu").on("bjui.datagrid.th.filter",
                function(q, n) {
                    var o = d(this),
        ...
        c.prototype.initEvents = function(f) {
            ...
            f.each(function() {
                var i = d(this);
                i.find("> td." + h.classnames.td_checkbox).find("input").on("ifClicked",
                    function() {
                        i.trigger("click.bjui.datagrid.tr", [d(this)])
                    })
            });
            if (h.checkboxColumn && h.checkboxColumn.th) {
                h.checkboxColumn.th.find("input").on("ifChanged",
                    function() {
        ...
        c.prototype.initTfoot = function() {
            ...
            h.$tfoot.on("bjui.datagrid.tfoot.resizeH",
                function() {
                    i.setBoxbH(e.height)
                })
        };
                ...
                if (f && f.length) {
                    f.filter("." + i.classnames.tr_edit).each(function() {
                        ...
                        if (l.hasClass(i.classnames.td_edit)) {
                            m = i.$tbody.find("> tr:eq(" + j + ")"),
                                n = m.find("> td:eq(" + index + ")");
        ...
        c.prototype.initLockEvents = function(f) {
            ...
            f.on("click.bjui.datagrid.tr",
                ...
                function(j, h) {
                    ...
                    i.remove()
                }).find("> td." + g.classnames.td_checkbox + " input").on("ifChanged",
                function() {
                    var j = d(this),
                        i = j.closest("tr"),
                        h = i.index();
        ...
        c.prototype.filterInThead = function() {
            ...
            var l = function(q, n, p) {
                var o = n.type;
                if (o == "date") {
                    q.on("afterchange.bjui.datepicker",
                        function(s, r) {
                            j(n, q.val())
                        }).change(function() {
                        j(n, q.val())
                    ...
                    if (o == "lookup") {
                        p.on("customEvent.bjui.lookup", '[data-toggle="lookupbtn"]',
                            function(t, r) {
                                for (var s in r) {
                                    if (n.name == s) {
                                        q.val(r[s]);
            ...
            d.each(h,
                function(o, r) {
                    ...
                    l(q, r, p);
                    q.on("bjui.datagrid.thead.clearfilter",
                        function() {
                            q.val("");
        ...
        c.prototype.colResize = function() {
            ...
            e.find("> tr > th").each(function(j) {
                ...
                l.on("mousedown.bjui.datagrid.resize",
                    function(u) {
        ...
        c.prototype.colMenu = function() {
            ...
            f.each(function() {
                var n = d(this),
                    ...
                    o;
                if (!k.length) {
                    o = d('<button class="btn btn-default"><i class="fa fa-bars"></button>'),
                        k = d('<div class="' + i.classnames.btn_menu + '"></div>').append(o);
                    k.appendTo(p);
                    o.click(function() {
                        var z = n.closest("tr"),
            ...
            i.$grid.on("click.bjui.datagrid.filter",
                function(m) {
                    var k = d(m.target),
        ...
        c.prototype.colFilter = function(g, z) {
            ...
            if (z) {
                ...
                if (!t || !t.length) {
                    ...
                    t.on("customEvent.bjui.lookup", '[data-toggle="lookupbtn"]',
                        function(G, i) {
                            for (var F in i) {
                                if (j.name == F) {
                                    e.val(i[F])
                ...
                l.find('> ul > li:not(".' + n.classnames.li_filter + '")').on("mouseover",
                    function() {
        ...
        c.prototype.initPaging = function() {
            ...
            j.$selectpage.on("bjui.datagrid.paging.pageSize",
                function(C, i) {
                    e(i)
                });
            p.find("input").on("keyup",
                function(C) {
            ...
            j.$refreshBtn.on("click",
                function() {
                    j.refresh()
                });
            j.$selectpage.on("change",
                function() {
                    var i = d(this).val();
                    j.jumpPage(null, i)
                })
        ...
        c.prototype.add = function(p) {
            ...
            var m = this,
                ...
                j = [],
                k,
                o = (f.pageCurrent - 1) * f.pageSize,
                g;
            var e = function(s) {
                var t = d("<tr></tr>").addClass(m.classnames.tr_add),
                    r = t.clone();
                d.each(m.columnModel,
                    function(v, x) {
                        var u = "",
                            w = d("<td></td>");
                        if (x.gridNumber) {
        ...
        c.prototype.inlineEdit = function(i, m, g) {
            ...
            f.each(function(r) {
                ...
                var u = function(z, B, A) {
                    ...
                    switch (t.type) {
                        case "date":
                            z.on("afterchange.bjui.datepicker",
                                function(D, C) {
                        ...
                        case "boolean":
                            ...
                            break;
                        case "lookup":
                            B.on("customEvent.bjui.lookup", '[data-toggle="lookupbtn"]',
                                function(E, C) {
                                    B.toggleClass(k.classnames.td_changed);
                                    for (var D in C) {
        ...
        c.prototype.saveAll = function(f) {
            ...
            f.each(function() {
                i = d(this),
                    g = k.isDom ? i.data("initData") : k.data[i.index()];
        ...
        c.prototype.dialogEdit = function(j, r, g) {
            ...
            var m = function(y, v, x, w) {
                ...
                switch (w.type) {
                    case "date":
                        x.on("afterchange.bjui.datepicker",
                            function(A, z) {
                                u[w.name] = x.val()
                            }).change(function() {
                            u[w.name] = x.val()
                    ...
                    case "boolean":
                        ...
                        break;
                    case "lookup":
                        v.on("customEvent.bjui.lookup", '[data-toggle="lookupbtn"]',
                            function(B, z) {
                                for (var A in z) {
        ...
        function b(f) {
            ...
            return this.each(function() {
                var j = d(this);
                var h = d.extend({},
                    c.DEFAULTS, j.data(), typeof f == "object" && f);
                var i = j.data("bjui.datagrid");
                if (!i) {
                    j.data("bjui.datagrid", (i = new c(this, h)))
                }
                if (typeof g == "string" && d.isFunction(i[g])) { [].shift.apply(e);
                    if (!e) {
                        i[g]()
                    } else {
                        i[g].apply(i, e)
        ...
        d(document).on(BJUI.eventType.initUI,
            function(g) {
    ...
    function(a) {
        ...
        b.SCROLLW = 18,
            ...
            b.prototype.initHead = function() {
                ...
                d.length > 1 && (j = 0, m = d.eq(1).find("> th"), a.each(i,
                    function(a, b) {
                        var c, d, f, g, h, i, k;
            ...
            b.prototype.initBody = function() {
                ...
                this.options.styles,
                    this.options.height ? g = this.options.height - this.$fixed.find(".fixedtableHeader").height() + "px": (g = "100%", h = function() {
                        var a = c.$fixed.parent().height();
                        c.$fixed.parent().css("overflow", "hidden"),
                            c.$fixed.height(a).find(".fixedtableScroller").height(a - c.$fixed.find(".fixedtableHeader").height())
                    },
                        a(document).one(BJUI.eventType.afterInitUI,
                            function() {
                                h()
                            })),
                    f = 'style="height:' + g + '; overflow-y:auto;"',
                    d.wrap('<div class="fixedtableScroller"' + f + ' style="width:' + this.options.newWidth + 'px;"><div class="fixedtableTbody"><table style="width:' + (this.options.newWidth - b.SCROLLW) + "px; max-width:" + (this.options.newWidth - b.SCROLLW) + 'px;"></table></div></div>'),
                    this.$element.attr("class") ? d.parent().addClass(this.$element.attr("class")) : d.parent().addClass("table table-striped table-bordered table-hover"),
                "undefined" != typeof this.$element.attr("data-selected-multi") && d.parent().attr("data-selected-multi", this.$element.attr("data-selected-multi")),
                    d.before('<thead><tr class="resize-head">' + this.$fixed.find("thead > tr").html() + "</tr></thead>"),
                    this.options.$tds = d.prev().find("> tr:first-child > th"),
                this.options.nowrap && d.parent().addClass("nowrap"),
                    d.closest(".fixedtableScroller").scroll(function() {
                        var c = a(this),
                            d = c.scrollLeft(),
            ...
            b.prototype.resizeCol = function() {
                ...
                d.find("thead > tr:gt(0) > th").each(function() {
                    ...
                    i.mouseover(function(a) {
                        ...
                        return i.outerWidth() - j < 5 ? i.css("cursor", "col-resize").off("mousedown.bjui.tablefixed.resize").on("mousedown.bjui.tablefixed.resize",
                            function(a) {
                ...
                var c = this,
                    d = function() {
                        a("div.bjui-resizeGrid").each(function() {
                            ...
                            d.length && d.is(":hidden") && (d.hasClass("tab-pane") || (e.show(), f = d.innerWidth(), g = d.height(), i = h.find(".fixedtableHeader").height(), e.hide())),
                            f && d.find(".bjui-tablefixed").each(function() {
                                var c = a(this);
                                k = c.data("resizeGrid") ? j: f,
                                    c.width(k),
                                    c.find(".table").width(k - b.SCROLLW),
                                    c.find(".fixedtableHeader").width(k - b.SCROLLW),
                                    c.find(".fixedtableScroller").width(k)
                            }),
                                d.css("overflow", "hidden"),
                                h.height(g).find(".fixedtableScroller").height(g - i)
                        })
                    };
            ...
            a(document).on(BJUI.eventType.afterInitUI,
                function(b) {
                    var d = a(b.target).find("th[data-order-field]");
                    d.length && c.call(d, "setOrderBy")
                }),
            a(document).on("click.bjui.tr.data-api", "tr[data-id]",
                function() {
                    var c = a(this),
                        d = c.closest("table"),
                    ...
                    c.toggleClass(g),
                        e ? (f = [], c.siblings("." + g).add(c.hasClass(g) ? c: "").each(function() {
                            f.push(a(this).attr("data-id"))
                        }), f = f.join(",")) : (c.siblings().removeClass(g), c.hasClass(g) || (f = "")),
...
+
    function(a) {
        ...
        b.DEFAULTS = {
                    ...
                    d = {
                        ...
                        initInput: function(b) {
                            b.find("> tr > td").each(function() {
                                ...
                                b.length || (b = a('<span class="input-hold" style="display:block; padding:0 4px; height:0px; font-size:12px; visibility:hidden;"></span>'), a(this).append(b)),
                                    a.support.leadingWhitespace ? a(this).on("input", ":text",
                                        function() {
                                            b.text(a(this).val())
                                        }) : a(this).on("propertychange", ":text",
                                        function() {
                                            b.text(a(this).val())
                                        })
                            })
                        ...
                        initTbody: function() {
                            function e(b) {
                                b.removeClass("readonly").find("> td *").each(function() {
                                    ...
                                    if (b.isTag("select") && b.val(c.attr("data-val")).selectpicker("refresh").nextAll(".bootstrap-select").removeClass("readonly").find("button").removeClass("disabled"), b.is(":checkbox") && (b.closest(".icheckbox_minimal-purple").removeClass("disabled"), b.closest(".icheckbox_minimal-purple").find("ins").removeClass("readonly")), b.is(":radio") && (b.closest(".iradio_minimal-purple").removeClass("disabled"), b.closest(".iradio_minimal-purple").find("ins").removeClass("readonly")), e) {
                                        ...
                                        "kindeditor" == e && c.initui()
                                    } (b.is(":text") || b.is("textarea")) && (b.off("keydown.readonly"), f && b.prop("readonly", !0)),
                            ...
                            function f(b) {
                                b.addClass("readonly").find("> td *").each(function() {
                                    ...
                                    if (b.isTag("select") && b.nextAll(".bootstrap-select").addClass("readonly").find("button").addClass("disabled"), b.is(":checkbox") && (b.closest(".icheckbox_minimal-purple").addClass("disabled"), b.closest(".icheckbox_minimal-purple").find("ins").addClass("readonly")), b.is(":radio") && (b.closest(".iradio_minimal-purple").addClass("disabled"), b.closest(".iradio_minimal-purple").find("ins").addClass("readonly")), d) {
                                        ...
                                        "kindeditor" == d && KindEditor.remove(b)
                                    } (b.is(":text") || b.is("textarea")) && b.on("keydown.readonly",
                                        function(a) {
                                            a.preventDefault()
                                        }),
                            ...
                            d.find("> tr").each(function() {
                                ...
                                d.on("click.bjui.tabledit.readonly", '[data-toggle="doedit"]',
                                    function() {
                                        e(a(this).closest("tr"))
                                    }).on("click.bjui.tabledit.readonly", '[data-toggle="dosave"]',
                                    function() {
                                        var i, j, e = a(this).closest("tr"),
                                            g = e.index(),
                                            h = c.options.callback;
                                        c.options.action ? (e.wrap('<form action="" method="POST"></form>'), e.attr("data-id") && (i = b.find("> thead > tr:eq(0)").data("idname") || "id", e.before('<input type="hidden" name="' + i.replaceSuffix(g) + '" value="' + e.attr("data-id") + '">')), j = e.parent().serializeArray(), c.options.singleNoindex && a.each(j,
                                            function(b, c) {
                                                a.extend(c, {
                        ...
                        doAdd: function() {
                            var b = c.$element;
                            c.$numAdd && c.$btnAdd && b.on("keydown.bjui.tabledit.add", "thead .num-add",
                                function(a) {
                                    a.which == BJUI.keyCode.ENTER && (c.$btnAdd.trigger("click.bjui.tabledit.add"), a.preventDefault())
                                }).on("click.bjui.tabledit.add", "thead .row-add",
                                function(a) {
                                    var d = 1;
                            ...
                            var b = this,
                                ...
                                f = function(f) {
                                    a.closest("tr").remove(),
                                        b.initSuffix(d),
                                        b.afterDelete(d),
                                    e.callback && e.callback.toFunc().apply(c, [f])
                                };
            ...
            a(document).on("click.bjui.tabledit.data-api", '[data-toggle="tableditadd"]',
                function(b) {
                    var d = a(this),
                        e = d.data("num") || 1,
                        f = d.data("target");
        ...
        b.DEFAULTS = {
            ...
            b.prototype.addBtn = function() {
                ...
                this.$lookBtn || c.parent().hasClass("wrap_bjui_btn_box") || (this.$spinner = a(FRAG.spinnerBtn), c.css({
                    ...
                    height: this.height
                }).appendTo(d), this.$spinner.on("selectstart",
                    function() {
                        return ! 1
                    }), e = null, b.$spinner.find("li").on("click",
                    function() {
        ...
        e.DEFAULTS = {
            ...
            e.prototype.addBtn = function() {
                ...
                this.$lookBtn || c.parent().hasClass("wrap_bjui_btn_box") || (this.$lookBtn = a(FRAG.lookupBtn), this.$element.css({
                    ...
                    height: e,
                    lineHeight: e + "px"
                }).appendTo(d), this.$lookBtn.on("selectstart",
                    function() {
                        return ! 1
                    }))
            },
            ...
            a(document).on("click.bjui.lookup.data-api", '[data-toggle="lookupbtn"]',
                function(b) {
                    var c = a(this);
            ...
            a(document).on("click.bjui.lookupback.data-api", '[data-toggle="lookupback"]',
                function(b) {
                    var c = a(this),
                        d = c.data("args"),
                        e = c.data("lookupid"),
        ...
        b.DEFAULTS = {
            ...
            b.prototype.TOOLS = function() {
                var c = this,
                    ...
                    e = {
                        ...
                        doQuery: function() {
                            var b, e, f, g, h;
                            d.max > 0 && c.$tagsArr.length >= d.max || (b = c.$element.val(), e = c.$box.find("> .tags-menu"), f = [], g = null, h = c.$element.closest(".navtab-panel").length ? a.CurrentNavtab: a.CurrentDialog, c.$element.closest(".bjui-layout").length && (h = c.$element.closest(".bjui-layout")), 0 != b.length && (c.$element.one("ajaxStart",
                                function() {
            ...
            b.prototype.init = function() {
                var b = this,
                    c = this.$element,
                    d = this.options;
                return d.url ? (d.url = decodeURI(d.url).replacePlh(c.closest(".unitBox")), d.url.isFinishedTm() ? (d.url = encodeURI(d.url), isNaN(this.options.max) ? (BJUI.debug("Tags Plugin: Parameter 'max' is non-numeric type!"), void 0) : (b.$box.width(d.width).on("click",
                    function() {
                        c.focus()
        ...
        b.DEFAULTS = {
                    ...
                    e = {
                        ...
                        renderQueueItem: function(b) {
                            ...
                            d.auto && c.fileUpload(b, e),
                                f.on("click.bjui.upload.confirm", ".up_confirm",
                                    function() {
                                        var d = a(this),
                                            f = d.closest(".item");
                                        d.hide().next().show(),
                        ...
                        successQueueItem: function(b, f) {
                            ...
                            d.onUploadSuccess && d.onUploadSuccess.toFunc().call(c, b, f.responseText, c.$element),
                                setTimeout(function() {
                                        c.$element.find("#" + b.id).fadeOut("normal",
                                            function() {
                                                a(this).remove();
                        ...
                        removeQueueItem: function(b, d) {
                            d && d.abort(),
                                a(this).closest(".item").fadeOut("normal",
                                    function() {
                                        a(this).remove();
                                        var b = c.$element.find("> .queue > .item:visible").length;
            ...
            b.prototype.init = function() {
                ...
                return d.uploader ? (d.uploader = decodeURI(d.uploader).replacePlh(c.closest(".unitBox")), d.uploader.isFinishedTm() ? (d.uploader = encodeURI(d.uploader), c.hasClass("bjui-upload") || (e = a(FRAG.uploadFrag.replaceAll("#multi#", d.multi ? "multiple": "").replaceAll("#accept#", b.tools.getAcceptString(d.fileTypeExts)).replaceAll("#btnTxt#", (d.icon ? '<i class="fa fa-' + d.icon + '">&nbsp;&nbsp;': "") + d.buttonText)), c.addClass("bjui-upload").append(e), this.$file = c.find("> .bjui-upload-select-file"), this.$uploadFileList = c.find("> .queue"), this.queueData = {
                    ...
                    c.on("change.bjui.upload", ".bjui-upload-select-file",
                        function(a) {
                            b.fileSelect(a)
                        }).on("click.bjui.upload", ".bjui-upload-select",
                        function() {
            ...
            b.prototype.fileUpload = function(b, c) {
                ...
                f.onUploadStart && f.onUploadStart(), f.formData.fileName = i.name, f.formData.lastModifiedDate = i.lastModifiedDate.getTime(), g.sendBlob(f.uploader, h, b, f.formData)),
                    e.find("#" + i.id + " > .info > .up_pause").on("click.bjui.upload.pause",
                        function() {
                            h.abort(),
    ...
    function(a) {
        ...
        a(function() {
            var d = function() {
                ...
                b = a("#bjui-link-theme"),
                    c = a("#bjui-themes"),
                a.cookie && (d = a.cookie("bjui_theme") || "blue", e = c.find("a.theme_" + d), e.theme({}))
            };
            d()
        }),
            d = function(b, c) {
            ...
            a(document).on("click.bjui.theme.data-api", '[data-toggle="theme"]',
                function(b) {
                    e.call(a(this)),
                        b.preventDefault()
                })
...
+
    function(a) {
        ...
        b.DEFAULTS = {},
            ...
            a(document).on("click.bjui.initui.data-api", '[data-toggle="initui"]',
                function(a) {
                    c.call($this, $this.data()),
                        a.preventDefault()
                }),
            a(document).on(BJUI.eventType.beforeInitUI,
                function(b) {
                    var c = a(b.target),
                        d = [],
            ...
            a(document).on(BJUI.eventType.afterInitUI,
                function(b) {
                    ...
                    d && a.each(d,
                        ...
                        c.resizePageH(),
                    e.length && c.find("> .bjui-pageFooter").find(":submit").on("click.bjui.submit",
                        function(a) {
                            a.preventDefault(),
                                e.submit()
                        }),
                        c.find(".bjui-maskProgress").find(".progress").stop().animate({
                            ...
                            "fast",
                            function() {
                                c.find(".bjui-ajax-mask").fadeOut("normal",
                                    function() {
                                        a(this).remove()
                                    })
                            })
            ...
            e = function(b) {
                ...
                g.length || (g = a(FRAG.maskBackground), h = a(FRAG.maskProgress.replace("#msg#", BJUI.regional.progressmsg)), c.prepend(g).prepend(h)),
            ...
            a(document).on("bjui.ajaxStart",
                function(b, c, d) {
                    var f = e(a(b.target));
                    f.$bg.fadeIn(),
                        f.$pr.fadeIn(),
                        f.$pr.find(".progress").animate({
                                width: "80%"
                            },
                            c || 500),
            ...
            a(document).on(BJUI.eventType.ajaxStatus,
                function(b) {
                    var c = a(b.target),
                        d = e(c);
                    c.one("ajaxStart",
            ...
            a(document).on(BJUI.eventType.beforeLoadDialog,
                function() {}).on(BJUI.eventType.beforeAjaxLoad,
                function(b) {
                    f(a(b.target))
                }).on(BJUI.eventType.beforeCloseNavtab,
                function(b) {
                    f(a(b.target))
                }).on(BJUI.eventType.beforeCloseDialog,
                function(b) {
                    f(a(b.target))
                }),
            a(function() {
                a(document).on("keydown keyup",
                    function(a) {
                        a.which === BJUI.keyCode.CTRL && (BJUI.KeyPressed.ctrl = "keydown" == a.type ? !0 : !1),
                        a.which === BJUI.keyCode.SHIFT && (BJUI.KeyPressed.shift = "keydown" == a.type ? !0 : !1)
                    })
            })
    } (jQuery);
/**
        ...
        a(document).on(BJUI.eventType.initUI,
            function(b) {
                ...
                d.each(function() {
                    ...
                    d.filter(".checkboxCtrl").on("ifChanged",
                        function(b) {
                    ...
                    e.each(function() {
                        ...
                        c.width || b.data("width", "auto"),
                            c.container ? 1 == c.container && b.attr("data-container", "false").data("container", !1) : b.data("container", "body"),
                            b.selectpicker(),
                    ...
                    c.find('[data-toggle="ztree"]').each(function() {
                        ...
                        function j(b, d, e) {
                            e.faiconClose && a("#" + e.tId + "_ico").find("> i").attr("class", "fa fa-" + e.faiconClose),
                                console.log("11"),
                            c.onCollapse && c.onCollapse.toFunc().call(this, b, d, e)
                        }
                        function k(b, d, e) {
                            e.faicon && e.faiconClose && a("#" + e.tId + "_ico").find("> i").attr("class", "fa fa-" + e.faicon),
                            c.onExpand && c.onExpand.toFunc().call(this, b, d, e)
                        }
                        function l(b, d) {
                            var e = d.level,
                                f = a("#" + d.tId + g),
                            ...
                            i.length || e < c.maxAddLevel && (i = a('<span class="tree_add" id="diyBtn_add_' + d.id + '" title="添加"></span>'), i.appendTo(f), i.on("click",
                                function() {
                                    h.addNodes(d, {
                                        name: "新增Item"
                                    })
                                })),
                            j.length || (j = a('<span class="tree_del" id="diyBtn_del_' + d.id + '" title="删除"></span>'), j.appendTo(f).on("click",
                                function(a) {
                                    var f, g, e = function() {
                        ...
                        var e, f, g, h, b = a(this),
                            c = b.data(),
                            d = c.options;
                        d && "string" == typeof d && (d = d.toObj()),
                        d && a.extend(c, "object" == typeof d && d),
                            e = c.setting,
                            c.nodes ? ("string" == typeof c.nodes && (c.nodes = c.nodes.trim().startsWith("[") || c.nodes.trim().startsWith("{") ? c.nodes.toObj() : c.nodes.toFunc()), "function" == typeof c.nodes && (c.nodes = c.nodes.call(this)), b.removeAttr("data-nodes")) : (c.nodes = [], b.find("> li").each(function() {
                                var b = a(this),
                                    d = b.data();
                                d.pid && (d.pId = d.pid),
                                    d.name = b.html(),
                        ...
                        c.addHoverDom && "function" != typeof c.addHoverDom && (c.addHoverDom = "edit" == c.addHoverDom ? l: c.addHoverDom.toFunc()),
                        c.removeHoverDom && "function" != typeof c.removeHoverDom && (c.removeHoverDom = "edit" == c.removeHoverDom ? m: c.removeHoverDom.toFunc()),
                        ...
                        e && "string" == typeof e && (e = e.toObj()),
                        e && a.extend(!0, f, "object" == typeof e && e),
                            a.fn.zTree.init(b, f, c.nodes),
                            g = "_a",
                            h = a.fn.zTree.getZTreeObj(b.attr("id")),
                        c.expandAll && h.expandAll(!0)
                    }),
                    ...
                    c.find('[data-toggle="dropdown"]').parent().on("show.bs.dropdown",
                        function() {
                            var c = a(this),
                                d = c.outerWidth(),
                    ...
                    i.each(function() {
                        ...
                        require.config({
                            ...
                            require(["echarts", "echarts/theme/" + d, "echarts/chart/" + e[0], e[1] ? "echarts/chart/" + e[1] : "echarts"],
                                function(d, e) {
                                    var f = d.init(b[0], e);
                                    a.get(c.url,
                                        function(a) {
